...
>(({ className, children, ...props }, ref) => (
    <DrawerPortal>
        ...
        <VaulDrawer.Content
            ref={ref}
            className={cn(
                "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-[96%] flex-col rounded-t-[10px] bg-white dark:bg-zinc-950 text-black dark:text-white outline-none",
                className
            )}
            {...props}
        >
            <div className="mx-auto mt-4 h-1.5 w-12 rounded-full bg-muted-foreground/40" />
